...
public class ScenarioForLogReplication extends Scenario<ClientCoordinatorForLogReplication> {
  ...
  public boolean evaluateSimulation(List<Client<String>> clients,
    ...
    /*List<Optional<Map<String, String>>> loggs = clusterProcesses.stream().map(rp -> rp.getLastSnapshotOfLog()).collect(Collectors.toList());
    for (Optional<Map<String, String>> o : loggs) { System.out.println(o); }*/
    ...
    System.out.println("Logy procesu:\n " + logs);
